...
class EmployeeExtractor:
    ...
    def extract_with_confidence(self, tables: List[pd.DataFrame]) -> Dict[str, Any]:
        """
        Extract employee info with confidence scores
        
        Returns:
            Dictionary with employee_info and confidence_scores
        """
